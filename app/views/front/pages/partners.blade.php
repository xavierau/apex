    ...
    <div class="col-xs-9">
        <section class="content" style="background-image: url('{{asset('assets/imgs/partners_background.jpg')}}')">
            <div class="content-wrapper">
                ...
                <img class="img-responsive" src="{{asset('assets/imgs/partners_1.jpg')}}" width="100%" alt=""/>
                 ...
                 <div class="row content-item">
                    <div class="col-xs-3">
                        <img class="img-responsive"  src="http://fc07.deviantart.net/fs70/i/2011/257/b/1/company_logo_design_idea_2_by_mancai-d49tpms.jpg" alt=""/>
                    </div>
                    <div class="col-xs-9">
